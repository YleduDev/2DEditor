...
public class ServerData
{
    ...
    string loginURL = "http://192.168.1.201:8080/vibe-web/user/login";
    string floorsUrl = "http://192.168.1.201:8080/vibe-web/asset/initAssetAllTree?flag=space&locationRoot=1";
    string categoryUrl = "http://192.168.1.201:8080/vibe-web/getItemsTree?catalogId=2002";
    string idUrl = "http://192.168.1.201:8080/vibe-web/asset/toDeviceEdit?id=";
